# DV Coverage Tracking — mutrig_timestamp_processor
...
- merged isolated total code coverage: `stmt=83.36, branch=69.88, cond=57.81, expr=90.00, fsm_state=100.00, fsm_trans=85.71, toggle=32.07`
