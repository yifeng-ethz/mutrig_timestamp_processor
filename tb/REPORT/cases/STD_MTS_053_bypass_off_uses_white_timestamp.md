# ✅ STD_MTS_053_bypass_off_uses_white_timestamp

**Bucket:** `BASIC` &nbsp; **Method:** `D` &nbsp; **Build:** `after` &nbsp; **Effort:** `signoff` &nbsp; **Result:** `pass`

## Intent

- **Scenario:** With `bypass_lapse=0`, expect the divider numerators to come from the padded 50-bit white timestamp path. Covers the normal operating mode.
...
|---|---|---|---|---|---|
| stmt | 80.37 | 80.37 | 0.92 | 93.14 | 0.92 |
| branch | 64.06 | 64.06 | 1.56 | 85.54 | 1.56 |
| cond | 41.59 | 41.59 | 2.65 | 72.56 | 2.65 |
| expr | 50.00 | 50.00 | 0.00 | 100.00 | 0.00 |
| fsm_state | 75.00 | 75.00 | 0.00 | 100.00 | 0.00 |
| fsm_trans | 22.22 | 22.22 | 0.00 | 66.66 | 0.00 |
| toggle | 19.58 | 19.58 | 6.63 | 37.76 | 6.63 |
