...
| ℹ️ | log | `uvm/logs/STRESS_MTS_120_sink_pattern_equivalence_summary_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STRESS_MTS_120_sink_pattern_equivalence_summary_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `128` |
| ℹ️ | log.csr | `24` |
...
| toggle | 18.58 | 0.15 | 0.00 | 50.91 | 0.00 |
