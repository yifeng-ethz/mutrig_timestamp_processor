...
| ℹ️ | log | [`uvm/logs/STRESS_MTS_027_multi_beat_packet_stream_after_s1.log`](../../uvm/logs/STRESS_MTS_027_multi_beat_packet_stream_after_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/STRESS_MTS_027_multi_beat_packet_stream_s1.ucdb`](../../uvm/cov_after/STRESS_MTS_027_multi_beat_packet_stream_s1.ucdb) |
| ℹ️ | log.csr | `6` |
| ℹ️ | log.inputs | `64` |
| ℹ️ | log.beats | `64` |
| ℹ️ | log.payloads | `64` |
...
|---|---|---|---|---|---|
| stmt | 80.18 | 1.25 | 0.00 | 88.51 | 0.00 |
| branch | 64.84 | 1.01 | 0.00 | 80.07 | 0.00 |
...
| toggle | 23.26 | 0.36 | 0.07 | 40.16 | 0.00 |
