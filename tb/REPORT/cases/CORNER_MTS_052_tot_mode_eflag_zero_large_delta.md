...
| ℹ️ | log | `uvm/logs/CORNER_MTS_052_tot_mode_eflag_zero_large_delta_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/CORNER_MTS_052_tot_mode_eflag_zero_large_delta_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `1` |
| ℹ️ | log.csr | `3` |
...
|---|---|---|---|---|---|
| stmt | 78.04 | 78.04 | 0.13 | 90.93 | 0.13 |
| branch | 60.06 | 60.06 | 0.33 | 81.29 | 0.33 |
...
| toggle | 9.23 | 9.23 | 0.06 | 45.00 | 0.06 |
