...
| ℹ️ | log | `uvm/logs/CORNER_MTS_074_debug_ts_expected_minus_one_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/CORNER_MTS_074_debug_ts_expected_minus_one_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `3` |
| ℹ️ | log.csr | `4` |
...
| toggle | 12.80 | 4.27 | 0.00 | 45.96 | 0.00 |
