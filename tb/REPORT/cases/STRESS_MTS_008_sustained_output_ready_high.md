...
| ℹ️ | log | `uvm/logs/STRESS_MTS_008_sustained_output_ready_high_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STRESS_MTS_008_sustained_output_ready_high_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `64` |
| ℹ️ | log.csr | `6` |
...
| toggle | 23.71 | 0.37 | 0.00 | 26.83 | 0.00 |
