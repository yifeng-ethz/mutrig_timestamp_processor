# ✅ CORNER_MTS_080_ts_delta_zero_boundary

**Bucket:** `EDGE` &nbsp; **Method:** `D` &nbsp; **Build:** `after` &nbsp; **Effort:** `signoff` &nbsp; **Result:** `pass`

## Intent

- **Scenario:** Drive repeated equal timestamps and verify `ts_delta` encodes a clean zero. Covers the sign-conversion zero point.
...
|---|---|---|---|---|---|
| stmt | 79.62 | 39.81 | 0.00 | 94.66 | 0.00 |
| branch | 63.28 | 31.64 | 0.00 | 89.14 | 0.00 |
...
| toggle | 13.80 | 6.90 | 0.10 | 50.27 | 0.05 |
