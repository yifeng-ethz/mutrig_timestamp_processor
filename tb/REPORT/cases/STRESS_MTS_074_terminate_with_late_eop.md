...
| ℹ️ | log | `uvm/logs/STRESS_MTS_074_terminate_with_late_eop_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STRESS_MTS_074_terminate_with_late_eop_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `8` |
| ℹ️ | log.csr | `6` |
...
| toggle | 14.27 | 1.78 | 0.00 | 49.02 | 0.00 |
