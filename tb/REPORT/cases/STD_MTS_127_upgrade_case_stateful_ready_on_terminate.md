...
- **Scenario:** Prove the delivered upgrade behavior in which `asi_ctrl_ready` remains low until upstream `endofrun`, local drain, and close-marker generation finish.
...
|---|---|---|---|---|---|
| stmt | 81.85 | 16.37 | 0.00 | 95.40 | 0.00 |
| branch | 69.92 | 13.98 | 0.00 | 91.89 | 0.00 |
...
| toggle | 8.66 | 1.73 | 0.00 | 50.64 | 0.00 |
