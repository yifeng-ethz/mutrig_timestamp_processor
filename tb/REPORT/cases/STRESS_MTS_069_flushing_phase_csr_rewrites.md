...
| ℹ️ | log | `uvm/logs/STRESS_MTS_069_flushing_phase_csr_rewrites_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STRESS_MTS_069_flushing_phase_csr_rewrites_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `160` |
| ℹ️ | log.csr | `228` |
...
|---|---|---|---|---|---|
| stmt | 83.18 | 0.52 | 0.00 | 93.06 | 0.00 |
| branch | 69.80 | 0.44 | 0.00 | 80.51 | 0.00 |
...
| toggle | 17.44 | 0.11 | 0.00 | 48.95 | 0.00 |
