...
| ℹ️ | log | `uvm/logs/NEG_MTS_043_equal_expected_latency_error_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/NEG_MTS_043_equal_expected_latency_error_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `3` |
| ℹ️ | log.csr | `4` |
...
| toggle | 11.57 | 3.86 | 0.00 | 30.58 | 0.00 |
