...
| ℹ️ | log | `uvm/logs/NEG_MTS_034_output_ready_low_single_fault_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/NEG_MTS_034_output_ready_low_single_fault_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `1` |
| ℹ️ | log.csr | `2` |
...
| toggle | 7.05 | 7.05 | 0.06 | 23.57 | 0.06 |
