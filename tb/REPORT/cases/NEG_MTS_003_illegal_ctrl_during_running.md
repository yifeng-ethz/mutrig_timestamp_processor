...
| ℹ️ | log | `uvm/logs/NEG_MTS_003_illegal_ctrl_during_running_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/NEG_MTS_003_illegal_ctrl_during_running_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `1` |
| ℹ️ | log.csr | `3` |
...
| toggle | 6.68 | 6.68 | 0.38 | 7.22 | 0.38 |
