...
| ℹ️ | log | [`uvm/logs/NEG_MTS_085_bank_string_changes_functionality_after_s1.log`](../../uvm/logs/NEG_MTS_085_bank_string_changes_functionality_after_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/NEG_MTS_085_bank_string_changes_functionality_s1.ucdb`](../../uvm/cov_after/NEG_MTS_085_bank_string_changes_functionality_s1.ucdb) |
| ℹ️ | log.beats | `128` |
| ℹ️ | log.csr | `6` |
...
|---|---|---|---|---|---|
| stmt | 80.92 | 0.63 | 0.00 | 95.18 | 0.00 |
| branch | 65.62 | 0.51 | 0.00 | 89.49 | 0.00 |
...
| toggle | 25.76 | 0.20 | 0.00 | 47.66 | 0.00 |
