...
| ℹ️ | log | `uvm/logs/CORNER_MTS_127_frame_corrupt_ignore_upgrade_gap_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/CORNER_MTS_127_frame_corrupt_ignore_upgrade_gap_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `5` |
| ℹ️ | log.csr | `3` |
...
| toggle | 7.87 | 1.57 | 0.00 | 46.73 | 0.00 |
