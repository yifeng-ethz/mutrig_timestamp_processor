...
| ℹ️ | log | `uvm/logs/STRESS_MTS_101_repeat_smoke_positive_vector_1k_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STRESS_MTS_101_repeat_smoke_positive_vector_1k_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `1000` |
| ℹ️ | log.csr | `6` |
...
|---|---|---|---|---|---|
| stmt | 77.02 | 0.08 | 0.00 | 93.70 | 0.00 |
| branch | 55.84 | 0.06 | 0.00 | 82.46 | 0.00 |
...
| toggle | 14.19 | 0.01 | 0.00 | 50.71 | 0.00 |
