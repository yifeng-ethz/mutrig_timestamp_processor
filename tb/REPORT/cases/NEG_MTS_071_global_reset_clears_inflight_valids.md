# ✅ NEG_MTS_071_global_reset_clears_inflight_valids

**Bucket:** `ERROR` &nbsp; **Method:** `D` &nbsp; **Build:** `after` &nbsp; **Effort:** `signoff` &nbsp; **Result:** `pass`

## Intent

- **Scenario:** Assert global reset with data in flight and require all stage valids to clear. Covers hard reset cleanup.
...
|---|---|---|---|---|---|
| stmt | 78.33 | 39.16 | 0.00 | 95.18 | 0.00 |
| branch | 62.89 | 31.45 | 0.00 | 89.45 | 0.00 |
...
| toggle | 8.93 | 4.46 | 0.00 | 46.10 | 0.00 |
