# ✅ NEG_MTS_129_ctrl_handshake_reflects_completion_upgrade
...
| ℹ️ | log | `uvm/logs/NEG_MTS_129_ctrl_handshake_reflects_completion_upgrade_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/NEG_MTS_129_ctrl_handshake_reflects_completion_upgrade_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `4` |
| ℹ️ | log.csr | `4` |
...
|---|---|---|---|---|---|
| stmt | 60.84 | 15.21 | 0.00 | 93.99 | 0.00 |
| branch | 52.27 | 13.07 | 0.00 | 86.77 | 0.00 |
