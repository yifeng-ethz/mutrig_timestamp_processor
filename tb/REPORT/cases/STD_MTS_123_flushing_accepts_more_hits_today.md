...
| ℹ️ | log | `uvm/logs/STD_MTS_123_flushing_accepts_more_hits_today_after_s1.log` — local generated artifact; intentionally not published |
| ℹ️ | ucdb | `uvm/cov_after/STD_MTS_123_flushing_accepts_more_hits_today_s1.ucdb` — local generated artifact; intentionally not published |
| ℹ️ | log.beats | `1` |
| ℹ️ | log.csr | `2` |
...
|---|---|---|---|---|---|
| stmt | 75.99 | 75.99 | 0.00 | 92.97 | 0.00 |
| branch | 61.03 | 61.03 | 0.00 | 85.48 | 0.00 |
...
| toggle | 7.16 | 7.16 | 0.00 | 44.58 | 0.00 |
